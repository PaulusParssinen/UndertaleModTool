...
public partial class UndertaleRoomEditor : DataUserControl
{
    ...
    public static Dictionary<IUndertaleObject, FrameworkElement> ObjElemDict { get; } = new();
    ...
    private Stack<IUndertaleObject> undoStack = new();
    ...
    private void TreeView_SelectedItemChanged(object sender, RoutedPropertyChangedEventArgs<object> e)
    {
        ...
        else if (e.NewValue is IUndertaleObject obj)
        {
    ...
    private IUndertaleObject movingObj;
    ...
    private IUndertaleObject AddObjectCopy(UndertaleRoom room, Layer layer, IUndertaleObject obj, bool showErrors, int insertIndex = -1, Point pos = new())
    {
        if (room is null || obj is null)
            return null;

        IUndertaleObject newObj = null;
    ...
    private void PaintObjects(Point gridMouse, IUndertaleObject other, UndertaleRoom room)
    {
        ...
        IUndertaleObject newObj = AddObjectCopy(room, layer, other, false, -1, gridMouse);
    ...
    private IUndertaleObject selectedObject;
    ...
    private void SelectObject(IUndertaleObject obj, bool focus = true)
    {
    ...
    {
        IUndertaleObject sourceItem = e.Data.GetData(e.Data.GetFormats()[^1]) as IUndertaleObject; // TODO: make this more reliable
    ...
    {
        IUndertaleObject sourceItem = e.Data.GetData(e.Data.GetFormats()[^1]) as IUndertaleObject;
    ...
    {
        IUndertaleObject selectedObj = ObjectEditor.Content as IUndertaleObject;
    ...
    private IUndertaleObject copied;
    ...
    public void Command_Paste(object sender, ExecutedRoutedEventArgs e)
    {
        ...
        if (copied != null)
        {
            ...
            IUndertaleObject newObj = AddObjectCopy(room, layer, copied, true, -1, mousePos);
    ...
    private void MoveItem(IUndertaleObject obj, int dist, bool focus = true)
    {
        if (obj is Layer)
        {
        ...
        if (newIndex != index)
        {
            ...
            if (layer is not null)
            {
                ...
                var rectPrev = ObjElemDict[prevObj as IUndertaleObject];
                ObjElemDict[obj] = rectPrev;
                ObjElemDict[prevObj as IUndertaleObject] = rect;
            }
        }
    ...
    {
        MenuItem menuitem = sender as MenuItem;
        DeleteItem(menuitem.DataContext as IUndertaleObject);
    }

    private void MenuItem_Copy_Click(object sender, RoutedEventArgs e)
    {
        MenuItem menuitem = sender as MenuItem;
        copied = menuitem.DataContext as IUndertaleObject;
    }
    ...
    private void MenuItem_Paste_Click(object sender, RoutedEventArgs e)
    {
        ...
        IUndertaleObject newObj = AddObjectCopy(room, layer, copied, true);
        if (newObj is not null)
            SelectObject(newObj);
    }
...
public partial class RoomCanvas : Canvas
{
    ...
    protected override void OnVisualChildrenChanged(DependencyObject visualAdded, DependencyObject visualRemoved)
    {
        if (!isGMS2)
        {
            if (visualAdded is ContentPresenter presAdded && presAdded.DataContext is IUndertaleObject objAdded)
                UndertaleRoomEditor.ObjElemDict[objAdded] = presAdded;

            if (visualRemoved is ContentPresenter presRemoved && presRemoved.DataContext is IUndertaleObject objRemoved)
...
public partial class LayerCanvas : Canvas
{
    ...
    public IUndertaleObject CurrentLayer { get; set; }
