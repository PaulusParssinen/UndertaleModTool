...
public interface IUndertaleObject
{
    /// <summary>
    /// Serializes this <see cref="IUndertaleObject"/> into a specified <see cref="UndertaleWriter"/>.
    /// </summary>
    /// <param name="writer">Where to serialize to.</param>
    void Serialize(UndertaleWriter writer);

    /// <summary>
    /// Deserializes this <see cref="IUndertaleObject"/> from a specified <see cref="UndertaleReader"/>.
    /// </summary>
...
public interface IUndertaleObjectWithBlobs
{
    void SerializeBlobBefore(UndertaleWriter writer);
}

public interface IPaddedObject // TODO: use this everywhere
{
    /// <summary>
    /// TODO!
    /// </summary>
...
public interface IPrePaddedObject
{
...
public interface IUndertaleResource : IUndertaleObject;

public interface IUndertaleNamedResource : IUndertaleResource
{
