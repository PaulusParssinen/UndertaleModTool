...
public abstract class UndertaleSingleChunk<T> : UndertaleChunk, IUndertaleSingleChunk where T : IUndertaleObject, new()
{
    public T Object;
    ...
    public IUndertaleObject GetObject() => Object;
...
public abstract class UndertaleListChunk<T> : UndertaleChunk, IUndertaleListChunk where T : IUndertaleObject, new()
{
...
public abstract class UndertaleAlignUpdatedListChunk<T> : UndertaleListChunk<T> where T : IUndertaleObject, new()
{
...
public abstract class UndertaleSimpleListChunk<T> : UndertaleChunk, IUndertaleSimpleListChunk where T : IUndertaleObject, new()
{
