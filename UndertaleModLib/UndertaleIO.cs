...
public interface UndertaleResourceRef : IUndertaleObject
{
...
public class UndertaleResourceById<T, ChunkT> : UndertaleResourceRef, IStaticChildObjectsSize, IDisposable where T : IUndertaleResource, new() where ChunkT : UndertaleListChunk<T>
{
...
public class UndertaleReader : AdaptiveBinaryReader
{
    ...
    private Dictionary<uint, IUndertaleObject> objectPool;
    private Dictionary<IUndertaleObject, uint> objectPoolRev;
    ...
    private void FillUnserializeCountDictionaries()
    {
        try
        {
            ...
            Type utObjectType = typeof(IUndertaleObject);
    ...
    public Dictionary<uint, IUndertaleObject> GetOffsetMap()
    {
        return objectPool;
    }

    public Dictionary<IUndertaleObject, uint> GetOffsetMapRev()
    {
    ...
    public uint GetChildObjectCount<T>() where T : IUndertaleObject
    {
        Type t = typeof(T);
    ...
    public T GetUndertaleObjectAtAddress<T>(uint address) where T : IUndertaleObject, new()
    {
        if (address == 0)
            return default(T);
        IUndertaleObject obj;
    ...
    public uint GetAddressForUndertaleObject(IUndertaleObject obj)
    {
        if (obj == null)
            return 0;
    ...
    public void ReadUndertaleObject<T>(T obj) where T : IUndertaleObject, new()
    {
        try
        {
    ...
    public T ReadUndertaleObject<T>() where T : IUndertaleObject, new()
    {
    ...
    public T ReadUndertaleObjectPointer<T>() where T : IUndertaleObject, new()
    {
...
public sealed class UndertaleWriter : FileBinaryWriter
{
    ...
    private Dictionary<IUndertaleObject, uint> objectPool = new Dictionary<IUndertaleObject, uint>();
    private Dictionary<IUndertaleObject, List<uint>> pendingWrites = new Dictionary<IUndertaleObject, List<uint>>();
    private Dictionary<IUndertaleObject, List<uint>> pendingStringWrites = new Dictionary<IUndertaleObject, List<uint>>();
    ...
    public Dictionary<IUndertaleObject, uint> GetObjectPool()
    {
        return objectPool;
    }
    ...
    public void WriteUndertaleObject<T>(T obj) where T : IUndertaleObject, new()
    {
        try
        {
    ...
    public void WriteUndertaleObjectPointer<T>(T obj) where T : IUndertaleObject, new()
    {
        if (obj == null)
        {
            Write(0x00000000u);
...
public static class UndertaleIO
{
    ...
    public static Dictionary<uint, IUndertaleObject> GenerateOffsetMap(Stream stream)
    {
